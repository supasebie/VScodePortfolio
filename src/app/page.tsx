...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Senior Full Stack Software Engineer</span> with <span className="text-work_experience_orange"> over 10 years</span> of experience in the software development.
        </div>
      ),
    },
